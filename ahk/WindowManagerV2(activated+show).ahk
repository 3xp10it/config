...
EVENT_OBJECT_FOCUS      := 0x8005   ; 窗口获得焦点
WM_APP                  := 0x8000
...
; 安装焦点事件钩子（EVENT_OBJECT_FOCUS）
hookFocus := SetWinEventHook(EVENT_OBJECT_FOCUS, EVENT_OBJECT_FOCUS, 0, WinEventProcCallback, TargetProcessId, 0, 0)
if !hookFocus {
    MsgBox("FOCUS 钩子安装失败，请以管理员身份运行。")
    ExitApp
}
